...
extern int64_t sys_munmap();
extern int64_t sys_pause();
extern int64_t sys_pause();
extern int64_t sys_sigaction();
extern int64_t sys_waitpid();
extern int64_t sys_sigret();
extern int64_t sys_module();

static int64_t (*syscalls[])(void) = {[SYS_debug] sys_debug,   [SYS_fork] sys_fork,           [SYS_exit] sys_exit,       [SYS_wait] sys_wait,     [SYS_pipe] sys_pipe,    [SYS_read] sys_read,
